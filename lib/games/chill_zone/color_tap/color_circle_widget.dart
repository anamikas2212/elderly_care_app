// FILE LOCATION: lib/games/chill_zone/color_tap/color_circle_widget.dart

import 'package:flutter/material.dart';
import 'color_tap_game.dart'; // ← ADD THIS LINE

class ColorCircleWidget extends StatefulWidget {
  final ColorCircleData data;
  final Function(Color) onTap;

  const ColorCircleWidget({Key? key, required this.data, required this.onTap})
    : super(key: key);
...
// Note: ColorCircleData is defined in color_tap_game.dart
