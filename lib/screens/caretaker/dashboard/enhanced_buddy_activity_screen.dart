...
class _EnhancedBuddyActivityScreenState
    extends State<EnhancedBuddyActivityScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _memoryService = EnhancedMemoryService(
      groqApiKey: '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', // Replace with your actual key
    );
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          StreamBuilder<int>(
            stream: _notificationService.getUnreadNotificationCount(widget.caretakerId),
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return _buildEmptyState(
            ...
            title: 'No alerts yet',
            subtitle: 'You\'ll be notified when ${widget.elderlyName} needs attention',
          );
        }
                    ...
                    _buildActionChip(
                      ...
                      onTap: () {
                        _notificationService.markAsResolved(
                            widget.caretakerId, notificationId);
  ...
  Widget _buildReportCard(Map<String, dynamic> report, String reportId) {
    ...
    final sentimentData = report['sentimentData'] as Map<String, dynamic>? ?? {};
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.analytics, color: Colors.blue[700], size: 28),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData && snapshot.data!.exists) {
          ...
          if (history.isNotEmpty) {
            ...
            trendLabel = 'Mood: $dominantSentiment • ${recent.length} data points';
          } else {
        ...
        final List<Color> gradientColors = wellnessScore >= 70
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          if (notification['severity'] == 'urgent')
            ElevatedButton(
              onPressed: () {
                _notificationService.markAsResolved(widget.caretakerId, notificationId);
          ...
          child: Column(
            ...
            children: [
              ...
              if (sentimentData['concerningPatterns'] != null &&
                  (sentimentData['concerningPatterns'] as List).isNotEmpty) ...[
                const SizedBox(height: 16),
                const Text(
                  'Concerning Patterns:',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
