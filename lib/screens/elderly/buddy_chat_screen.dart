...
Always start your response with a sentiment analysis tag in this format: [SENTIMENT:positive/negative/neutral/anxious/sad/happy/angry]

Keep responses conversational, supportive, and around 2-4 sentences unless the user needs more detailed help.''',
        ),
      ],
    );
  }
...
class _BuddyChatScreenState extends State<BuddyChatScreen> {
  ...
  String _generateResponse(String userMessage) {
    ...
    if (message.contains('hello') || message.contains('hi')) {
      ...
      return 'I\'m doing great, thank you for asking! I\'m here to chat with you anytime. How are YOU doing today?';
    } else if (message.contains('pill') || message.contains('medicine')) {
      return 'Don\'t forget to take your pills on time! You can check your pill reminder from the home screen. Would you like me to remind you about something?';
    } else if (message.contains('sad') || message.contains('lonely')) {
      return 'I\'m sorry you\'re feeling that way. Remember, I\'m always here to chat with you. Would you like to play a game or talk about something that makes you happy?';
    } else if (message.contains('game') || message.contains('play')) {
      return 'That sounds fun! You can play brain games from the home screen. They\'re great for keeping your mind sharp! 🎮🧠';
    } else if (message.contains('help')) {
      return 'I\'m here to help! You can ask me about your pills, play games, or just chat. What would you like to do?';
    } else if (message.contains('thank')) {
      return 'You\'re very welcome! I\'m always happy to help you. Feel free to chat anytime! 💙';
    } else {
